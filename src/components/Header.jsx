...
export default function Header() {
    ...
    return (
        <div className="flex flex-col justify-items-center">
            ...
            <nav className={`bg-[#082434] flex flex-col w-60 h-screen p-5 absolute right-0 top-0 transition-transform transform ${abrirMenu ? 'translate-x-0' : 'translate-x-full'} md:hidden`}>
